...
awful.spawn.with_shell("python $HOME/resources/scripts/monitor-placer.py --lightdm")
awful.spawn.with_shell("sleep 5 && wal -i ~/resources/backgrounds/mikurain.jpg")
-- awful.spawn.with_shell("sleep 10 && wal -i ~/resources/backgrounds/ruins.png")
awful.spawn.with_shell("sleep 10 && xmousepasteblock")
